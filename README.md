...
You can use the [editor on GitHub](https://github.com/ayseA/export-database-structure-and-not-content/edit/master/README.md) to maintain and preview the content for your website in Markdown files.
